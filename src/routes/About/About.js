            ...
            <ScrollAnimation animateIn="fadeIn">
                <div className={styles.main}>
                    ...
                    <div className={styles.image}>
                        <img className={`${styles.headshot} ${this.state.catHover && styles.hide}`} src={require('../../images/headshot.JPG')}></img>
                        <img className={`${styles.cats} ${this.state.catHover && styles.show}`} src={require('../../images/cats.JPG')}></img>
                    </div>
                </div>
            </ScrollAnimation>
        );
